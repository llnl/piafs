...
/*! Function to calculate and save the nonlinear interpolation coefficients for a non-linear (solution-dependent) interpolation scheme (eg. #_FIFTH_ORDER_WENO_, #_FIFTH_ORDER_CRWENO_, etc). */
 ...
 * This structure contains the variables/parameters needed by the WENO-type scheme (#_FIFTH_ORDER_WENO_, #_FIFTH_ORDER_CRWENO_).
*/
/*! \brief Structure of variables/parameters needed by the WENO-type scheme
 *
 * This structure contains the variables/parameters needed by the WENO-type scheme (#_FIFTH_ORDER_WENO_, #_FIFTH_ORDER_CRWENO_).
 ...
 * This structure contains the variables/parameters needed by a compact scheme (#_FIFTH_ORDER_COMPACT_UPWIND_, #_FIFTH_ORDER_CRWENO_).
*/
/*! \brief Structure of variables/parameters needed by the compact schemes
 *
 * This structure contains the variables/parameters needed by a compact scheme (#_FIFTH_ORDER_COMPACT_UPWIND_, #_FIFTH_ORDER_CRWENO_).
