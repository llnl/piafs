...
#define _NavierStokes3DLeftEigenvectors_(u,L,ga,nvars,dir) \
  { \
    ...
    a = sqrt(ga * P / rho); \
    if (dir == _XDIR_) { \
      L[1*_NS3D_NVARS_+0] = (ga_minus_one*ek + a*vx) / (2*a*a); \
      L[1*_NS3D_NVARS_+1] = ((-ga_minus_one)*vx-a) / (2*a*a); \
      L[1*_NS3D_NVARS_+2] = ((-ga_minus_one)*vy) / (2*a*a); \
      L[1*_NS3D_NVARS_+3] = ((-ga_minus_one)*vz) / (2*a*a); \
      L[1*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[0*_NS3D_NVARS_+0] = (a*a - ga_minus_one*ek) / (a*a); \
      L[0*_NS3D_NVARS_+1] = (ga_minus_one*vx) / (a*a); \
      L[0*_NS3D_NVARS_+2] = (ga_minus_one*vy) / (a*a); \
      L[0*_NS3D_NVARS_+3] = (ga_minus_one*vz) / (a*a); \
      L[0*_NS3D_NVARS_+4] = (-ga_minus_one) / (a*a); \
      L[4*_NS3D_NVARS_+0] = (ga_minus_one*ek - a*vx) / (2*a*a); \
      L[4*_NS3D_NVARS_+1] = ((-ga_minus_one)*vx+a) / (2*a*a); \
      L[4*_NS3D_NVARS_+2] = ((-ga_minus_one)*vy) / (2*a*a); \
      L[4*_NS3D_NVARS_+3] = ((-ga_minus_one)*vz) / (2*a*a); \
      L[4*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[2*_NS3D_NVARS_+0] = vy; \
      L[2*_NS3D_NVARS_+1] = 0.0; \
      L[2*_NS3D_NVARS_+2] = -1.0; \
      L[2*_NS3D_NVARS_+3] = 0.0; \
      L[2*_NS3D_NVARS_+4] = 0.0; \
      L[3*_NS3D_NVARS_+0] = -vz; \
      L[3*_NS3D_NVARS_+1] = 0.0; \
      L[3*_NS3D_NVARS_+2] = 0.0; \
      L[3*_NS3D_NVARS_+3] = 1.0; \
      L[3*_NS3D_NVARS_+4] = 0.0; \
    } else if (dir == _YDIR_) {  \
      L[2*_NS3D_NVARS_+0] = (ga_minus_one*ek+a*vy) / (2*a*a); \
      L[2*_NS3D_NVARS_+1] = ((1.0-ga)*vx) / (2*a*a); \
      L[2*_NS3D_NVARS_+2] = ((1.0-ga)*vy-a) / (2*a*a); \
      L[2*_NS3D_NVARS_+3] = ((1.0-ga)*vz) / (2*a*a); \
      L[2*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[0*_NS3D_NVARS_+0] = (a*a-ga_minus_one*ek) / (a*a); \
      L[0*_NS3D_NVARS_+1] = ga_minus_one*vx / (a*a); \
      L[0*_NS3D_NVARS_+2] = ga_minus_one*vy / (a*a); \
      L[0*_NS3D_NVARS_+3] = ga_minus_one*vz / (a*a); \
      L[0*_NS3D_NVARS_+4] = (1.0 - ga) / (a*a); \
      L[4*_NS3D_NVARS_+0] = (ga_minus_one*ek-a*vy) / (2*a*a); \
      L[4*_NS3D_NVARS_+1] = ((1.0-ga)*vx) / (2*a*a); \
      L[4*_NS3D_NVARS_+2] = ((1.0-ga)*vy+a) / (2*a*a); \
      L[4*_NS3D_NVARS_+3] = ((1.0-ga)*vz) / (2*a*a); \
      L[4*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[1*_NS3D_NVARS_+0] = -vx; \
      L[1*_NS3D_NVARS_+1] = 1.0; \
      L[1*_NS3D_NVARS_+2] = 0.0; \
      L[1*_NS3D_NVARS_+3] = 0.0; \
      L[1*_NS3D_NVARS_+4] = 0; \
      L[3*_NS3D_NVARS_+0] = vz; \
      L[3*_NS3D_NVARS_+1] = 0.0; \
      L[3*_NS3D_NVARS_+2] = 0.0; \
      L[3*_NS3D_NVARS_+3] = -1.0; \
      L[3*_NS3D_NVARS_+4] = 0; \
    } else if (dir == _ZDIR_) {  \
      L[3*_NS3D_NVARS_+0] = (ga_minus_one*ek+a*vz) / (2*a*a); \
      L[3*_NS3D_NVARS_+1] = ((1.0-ga)*vx) / (2*a*a); \
      L[3*_NS3D_NVARS_+2] = ((1.0-ga)*vy) / (2*a*a); \
      L[3*_NS3D_NVARS_+3] = ((1.0-ga)*vz-a) / (2*a*a); \
      L[3*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[0*_NS3D_NVARS_+0] = (a*a-ga_minus_one*ek) / (a*a); \
      L[0*_NS3D_NVARS_+1] = ga_minus_one*vx / (a*a); \
      L[0*_NS3D_NVARS_+2] = ga_minus_one*vy / (a*a); \
      L[0*_NS3D_NVARS_+3] = ga_minus_one*vz / (a*a); \
      L[0*_NS3D_NVARS_+4] = (1.0-ga) / (a*a); \
      L[4*_NS3D_NVARS_+0] = (ga_minus_one*ek-a*vz) / (2*a*a); \
      L[4*_NS3D_NVARS_+1] = ((1.0-ga)*vx) / (2*a*a); \
      L[4*_NS3D_NVARS_+2] = ((1.0-ga)*vy) / (2*a*a); \
      L[4*_NS3D_NVARS_+3] = ((1.0-ga)*vz+a) / (2*a*a); \
      L[4*_NS3D_NVARS_+4] = ga_minus_one / (2*a*a); \
      L[1*_NS3D_NVARS_+0] = vx; \
      L[1*_NS3D_NVARS_+1] = -1.0; \
      L[1*_NS3D_NVARS_+2] = 0.0; \
...
#define _NavierStokes3DRightEigenvectors_(u,R,ga,nvars,dir) \
  { \
    ...
    if (dir == _XDIR_) { \
      R[0*_NS3D_NVARS_+1] = 1.0; \
      R[1*_NS3D_NVARS_+1] = vx-a; \
      R[2*_NS3D_NVARS_+1] = vy; \
      R[3*_NS3D_NVARS_+1] = vz; \
      R[4*_NS3D_NVARS_+1] = h0 - a*vx; \
      R[0*_NS3D_NVARS_+0] = 1.0; \
      R[1*_NS3D_NVARS_+0] = vx; \
      R[2*_NS3D_NVARS_+0] = vy; \
      R[3*_NS3D_NVARS_+0] = vz; \
      R[4*_NS3D_NVARS_+0] = ek; \
      R[0*_NS3D_NVARS_+4] = 1.0; \
      R[1*_NS3D_NVARS_+4] = vx+a; \
      R[2*_NS3D_NVARS_+4] = vy; \
      R[3*_NS3D_NVARS_+4] = vz; \
      R[4*_NS3D_NVARS_+4] = h0 + a*vx; \
      R[0*_NS3D_NVARS_+2] = 0.0; \
      R[1*_NS3D_NVARS_+2] = 0.0; \
      R[2*_NS3D_NVARS_+2] = -1.0; \
      R[3*_NS3D_NVARS_+2] = 0.0; \
      R[4*_NS3D_NVARS_+2] = -vy; \
      R[0*_NS3D_NVARS_+3] = 0.0; \
      R[1*_NS3D_NVARS_+3] = 0.0; \
      R[2*_NS3D_NVARS_+3] = 0.0; \
      R[3*_NS3D_NVARS_+3] = 1.0; \
      R[4*_NS3D_NVARS_+3] = vz; \
    } else if (dir == _YDIR_) { \
      R[0*_NS3D_NVARS_+2] = 1.0; \
      R[1*_NS3D_NVARS_+2] = vx; \
      R[2*_NS3D_NVARS_+2] = vy-a; \
      R[3*_NS3D_NVARS_+2] = vz; \
      R[4*_NS3D_NVARS_+2] = h0 - a*vy; \
      R[0*_NS3D_NVARS_+0] = 1.0; \
      R[1*_NS3D_NVARS_+0] = vx; \
      R[2*_NS3D_NVARS_+0] = vy; \
      R[3*_NS3D_NVARS_+0] = vz; \
      R[4*_NS3D_NVARS_+0] = ek; \
      R[0*_NS3D_NVARS_+4] = 1.0; \
      R[1*_NS3D_NVARS_+4] = vx; \
      R[2*_NS3D_NVARS_+4] = vy+a; \
      R[3*_NS3D_NVARS_+4] = vz; \
      R[4*_NS3D_NVARS_+4] = h0 + a*vy; \
      R[0*_NS3D_NVARS_+1] = 0.0; \
      R[1*_NS3D_NVARS_+1] = 1.0; \
      R[2*_NS3D_NVARS_+1] = 0.0; \
      R[3*_NS3D_NVARS_+1] = 0.0; \
      R[4*_NS3D_NVARS_+1] = vx; \
      R[0*_NS3D_NVARS_+3] = 0.0; \
      R[1*_NS3D_NVARS_+3] = 0.0; \
      R[2*_NS3D_NVARS_+3] = 0.0; \
      R[3*_NS3D_NVARS_+3] = -1.0; \
      ...
      R[0*_NS3D_NVARS_+3] = 1.0; \
      R[1*_NS3D_NVARS_+3] = vx; \
      R[2*_NS3D_NVARS_+3] = vy; \
      R[3*_NS3D_NVARS_+3] = vz-a; \
      R[4*_NS3D_NVARS_+3] = h0-a*vz; \
      R[0*_NS3D_NVARS_+0] = 1.0; \
      R[1*_NS3D_NVARS_+0] = vx; \
      R[2*_NS3D_NVARS_+0] = vy; \
      R[3*_NS3D_NVARS_+0] = vz; \
      ...
      R[1*_NS3D_NVARS_+4] = vx; \
      R[2*_NS3D_NVARS_+4] = vy; \
      R[3*_NS3D_NVARS_+4] = vz+a; \
      R[4*_NS3D_NVARS_+4] = h0+a*vz; \
      R[0*_NS3D_NVARS_+1] = 0.0; \
      R[1*_NS3D_NVARS_+1] = -1.0; \
      R[2*_NS3D_NVARS_+1] = 0.0; \
      R[3*_NS3D_NVARS_+1] = 0.0; \
