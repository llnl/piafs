...
/*! Applies the subsonic "ambivalent" boundary condition:
    ...
    Navier-Stokes systems (#NavierStokes2D).
*/
    ...
    if (boundary->on_this_proc) {
      ...
      while (!done) {
        ...
        double uvel1, uvel2, uvelb,
               vvel1, vvel2, vvelb;
        _NavierStokes2DGetFlowVar_((phi+nvars*p1),rho,uvel1,vvel1,energy,pressure,physics.gamma);
        _NavierStokes2DGetFlowVar_((phi+nvars*p2),rho,uvel2,vvel2,energy,pressure,physics.gamma);
        ...
        _NavierStokes2DGetFlowVar_((phi+nvars*p2),rho,uvel,vvel,energy,pressure,physics.gamma);
