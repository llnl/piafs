                          ...
                          )
{
  ...
  */
  ...
  IERR solver->InterpolateInterfacesHyp(uL   ,u    ,u,x, 1,dir,solver,mpi,1); CHECKERR(ierr);
  IERR solver->InterpolateInterfacesHyp(uR   ,u    ,u,x,-1,dir,solver,mpi,1); CHECKERR(ierr);
