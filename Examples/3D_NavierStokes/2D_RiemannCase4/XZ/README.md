...
| size | 201 21 201 | Grid size (for 1D) or grid dimensions separated by spaces (for 2D/3D) |
| iproc | 5 1 5 | Number of MPI ranks in each dimension (for parallel runs) |
...
extrapolate      0    -1     0      0  -0.5    0.5  -0.5    0.5
periodic         1     1  -0.5    0.5     0      0  -0.5    0.5
periodic         1    -1  -0.5    0.5     0      0  -0.5    0.5
